        ...
        <section className="bg-slate-800 min-h-screen ">
          <nav className="py-4 mb-6 flex justify-between">
            ...
            <ul className="flex items-center z-40">
              <li>    
                <a href="https://github.com/Rohit0701-create/MyPortfolio/blob/main/NewResume.pdf" className="bg-gradient-to-r from-emerald-800 to-emerald-700 text-white px-4 py-2 rounded-md ml-6" target="_blank" rel="noopener noreferrer">Resume</a>
              </li>
            </ul>
            </nav>
